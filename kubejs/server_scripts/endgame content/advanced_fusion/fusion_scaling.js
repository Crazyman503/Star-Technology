ServerEvents.recipes(event => {
    ...
    Fusion('tritanium',144,'titanium',288,'duranium',144,30720,21.6,200);
    ...
    Fusion('neutronium',144,'americium',216,'naquadria',288,98304,45,600);
    ...
    Fusion('paradox_plasma',144,'chaos_centric_void',200,'order_centric_void',200,294912,16.2,900);
    Fusion('magmatic_plasma',144,'infernal_concentrate',500,'iron_plasma',288,66666,12.8,720);
    Fusion('voidic_plasma',144,'echo_r',432,'void',144,344064,19.2,1040);
    Fusion('preon_plasma',144,'utopian_akreyrium',500,'dragon_breath',50,688128,9.6,1160);
    Fusion('borealic_concentrate',144,'stellarium',135,'aurourium',9,1023948,3.6,1200);
