StartupEvents.registry('item', event => {
    ...
    event.create('draconic_processor_mainframe')
        .tooltip(Text.translate('item.kubejs.draconic_processor_mainframe.tooltip'))
