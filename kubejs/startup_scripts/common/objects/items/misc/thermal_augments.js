    ...
    */
    ...
    const upgrade_kit = (tier) => {
        event.create(`${tier}_upgrade_kit`)
            ...
            .texture(`kubejs:item/misc/upgrade_kits/${tier}_kit`);
    };
    ...
    const arc_kit = (tier) => {
        event.create(`${tier}_arc_kit`)
            ...
            .texture(`kubejs:item/misc/arc_kits/${tier}_arc_kit`);
    };
    ...
    const mci_kit = (tier) => {
        event.create(`${tier}_mci_kit`)
            ...
            .texture(`kubejs:item/misc/mci_kits/${tier}_mci_kit`);
    };
    ...
    const fls_kit = (tier) => {
        event.create(`${tier}_fls_kit`)
            ...
            .texture(`kubejs:item/misc/fls_kits/${tier}_fls_kit`);
    };
    ...
    const rfc_kit = (tier) => {
        event.create(`${tier}_rfc_kit`)
            ...
            .texture(`kubejs:item/misc/rfc_kits/${tier}_rfc_kit`);
    };
    ...
    const rfs_kit = (tier) => {
        event.create(`${tier}_rfs_kit`)
            ...
            .texture(`kubejs:item/misc/rfs_kits/${tier}_rfs_kit`);
    };
    ...
    const rft_kit = (tier) => {
        event.create(`${tier}_rft_kit`)
            ...
            .texture(`kubejs:item/misc/rft_kits/${tier}_rft_kit`);
    };
